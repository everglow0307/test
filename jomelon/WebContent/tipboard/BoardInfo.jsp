			...
			<table width = "600" border="1" bordercolor = "gray" class="type06">
				...
				<tr height = "40">
					<td align ="center" colspan = "4">
						...
						<input type="button" class="button" value="수정하기" onclick="location.href='BoardUpdateForm.jsp?num=<%=bean.getNum()%>'"> 
						<input type="button" class="button" value="삭제하기" onclick="location.href='BoardDeleteForm.jsp?num=<%=bean.getNum()%>'"> 
						<input type="button" class="button" value="목록보기" onclick="location.href='BoardList.jsp'">     
					</td>
				</tr>
		</table>
	</center>
